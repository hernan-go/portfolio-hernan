...
export function Work() {
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 left-0 hidden w-[17rem] overflow-hidden select-none xl:block"
      >
      ...
      >
        ...
        <div
          className="mt-10 grid grid-cols-1 gap-x-5 gap-y-9 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 xl:gap-y-0"
        ...
        >
          {projects.map((project) => {
            ...
            return (
              ...
              >
                <div className="mb-3 min-h-9 font-['IBM_Plex_Mono']">
                  <h3
                    className={`text-[0.8rem] uppercase leading-[2.5] tracking-[0.09em] transition-colors duration-200 ${
                      isActive
                        ? "text-neutral-100"
                ...
                <div
                  className={`relative aspect-[10/6.5] overflow-hidden border bg-neutral-800/45 transition-all duration-300 ${
                    isActive
                      ? "border-neutral-300"
                ...
                <span
                  aria-hidden="true"
                  className={`mx-auto mt-3 block h-0.5 w-[42%] transition-all duration-300 ${
                    isActive
        ...
        >
          <div className="grid gap-10 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] lg:items-start lg:gap-14">
            <div className="relative aspect-[5/4] overflow-hidden bg-neutral-800/55">
            ...
            <div className="font-['IBM_Plex_Mono']">
              <div>
                <p className="mb-1 text-[0.9rem] uppercase tracking-[0.24em] text-neutral-400">
                  Active case
                </p>

                <h3 className="font-['Archivo_Black'] text-[clamp(2rem,2.7vw,2.75rem)] uppercase leading-none tracking-[-0.035em] text-neutral-100">
                  {activeProject.name}
                </h3>
              </div>

              <p className="mt-4 max-w-3xl text-[0.82rem] leading-6 text-neutral-400">
                {activeProject.descriptor}
              </p>

              <dl className="mt-8 space-y-5">
                <div>
                  <dt className="text-[0.8rem] uppercase tracking-[0.2em] text-neutral-500">
                    Role
                  </dt>
                  <dd className="mt-1.5 text-[0.82rem] leading-5 text-neutral-300">
                    {activeProject.role}
                  </dd>
                </div>
